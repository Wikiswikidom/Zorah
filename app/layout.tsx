...
import "./globals.css";import "./commerce.css";import "./landing.css";import "./login.css";import "./account.css";import "./storefront-commerce.css";import "./admin-ui.css";import "./storefront-header.css";
...
export default function RootLayout({children}:{children:Readonly<{children:React.ReactNode}>["children"]}){return <html lang="en"><body className={`${display.variable} ${sans.variable}`}><CommerceProvider>{children}</CommerceProvider></body></html>}
