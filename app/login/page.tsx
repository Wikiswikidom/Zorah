        ...
        <div className="login-card">
          ...
          {!signupOpen && <>
            ...
            <form action={signInWithPassword} className="login-form">
              ...
              <AuthSubmitButton className="login-submit" pendingLabel="Signing in…">Sign in</AuthSubmitButton>
            </form>
          </>}
          ...
          <details className="login-register" open={signupOpen}>
            ...
            {!signupOpen && <div className="login-note">Your account is secured by Supabase Auth. Passwords are never stored in the browser.</div>}
            <form action={signUpWithPassword} className="login-form">
              <input type="hidden" name="next" value={next} />
              <div className="login-field"><label htmlFor="fullName">Full name</label><input id="fullName" name="fullName" type="text" autoComplete="name" maxLength={160} required /></div>
              ...
              <AuthSubmitButton className="login-submit" pendingLabel="Creating account…">Create account</AuthSubmitButton>
            </form>
          </details>
